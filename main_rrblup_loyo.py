...
run_dir = os.path.join("Result", f"rrblup_loyo_{seed}")
...
for fold_id, test_year in enumerate(years, start=1):
    ...
    fold_row = {
        ...
        "final_test_hir_rrmse": rrmse_metric_np(y_test, test_pred),
        "final_test_hir_rmse": rmse_metric_np(y_test, test_pred),
